  ...
  return (
    <section className="relative z-20 mx-auto max-w-7xl py-20 lg:py-28">
      ...
      <div className="relative">
        <div className="mt-12 grid grid-cols-1 rounded-md lg:grid-cols-6 xl:border border-border/50">
...
export const SkeletonOne = () => {
  return (
    <div className="relative flex h-full gap-10 px-2 py-8">
      <div className="group mx-auto h-full w-full bg-surface p-5 shadow-2xl rounded-xl">
    ...
    >
      <div className="group mx-auto h-full w-full bg-transparent">
        <div className="relative flex h-full w-full flex-1 flex-col space-y-2">
          <FaYoutube className="absolute inset-0 z-10 m-auto h-20 w-20 text-red-500" />
          <img
      ...
      <div className="-ml-20 flex flex-row">
        {images.map((image, idx) => (
          <motion.div
            ...
            whileTap="whileTap"
            className="mt-4 -mr-4 shrink-0 overflow-hidden rounded-xl border border-border/50 bg-surface p-1"
          >
            <img
              src={image}
              alt="bali images"
